            ...
            if($staff_checks){
                ...
                //password length 
                    if(!$user->user_not_exists($staff_id)){
                            if($user->delete_user($staff_id)){
                                $error = "<Span class='alert alert-success'>Success</span>";
                            }else{
                                $error = "<span class='alert alert-danger'>Sorry Updating User Details not Successful</span>";
                            }
                        }else{
                            $error = "<span class='alert alert-danger'>User Doesn't Exists</span>";
                        }
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="login-panel panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Delete User Here </h3>
                            </div>
                            <div class="panel-body">
                                <form role="form" method="post" action="">
                                    <fieldset>
                                        ...
                                        <!-- <div class="form-group">
                                            <input class="form-control" placeholder="Password" name="password" type="password" hidden="true" value="" required>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" placeholder="Confirm Password " name="cpassword" type="password" hidden="hidden" value="" required>
                                        </div> -->
                                        
                                        
                                        <!-- Change this to a button or input when using this as a form -->
                                        <input class="btn btn-lg btn-success btn-block" type="submit" name="delete_user" value="Delete User">
                                      <br>
                                          <?php 
                                            if(isset($error)){
                                                echo $error;
