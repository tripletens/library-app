        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div class="huge">
                                        <?php 
                                             $user = new user();
                                             $conn = $user->__construct();
                                            $query = "SELECT `id`, `staff_id`, `first_name`, `last_name`, `unit`, `authority`, `password`, `cpassword`, `date` FROM `register_user`";
                                            $run_query = $conn->query($query);
                                            if($run_query){
                                                $count = mysqli_num_rows($run_query);
                                                echo $count;
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">No Of Registered Users</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
            ...
            <!-- /.row -->
             <div class="container-fluid" style="">
                <img src="./../images/img1.Jpg" height="200" width="200px; class="img-responsive pull-right">
                <div class="container-fluid">
                    ...
                    <h3> Phone No : <?php if(isset($_SESSION['phone'])){
                                                echo $_SESSION['phone'];
                                    }?>
                    </h3>
                    <h3> Email : <?php 
