                ...
                if($user->password_length($password,$cpassword)){
                    if($user->password_match($password,$cpassword)){
                        if(!$user->user_not_exists($staff_id)){
                            if($user->edit_user($staff_id ,$fname, $lname, $unit , $authority, $passwordhash , $cpasswordhash)){
                            ...
                            <div class="panel-body">
                                <form role="form" method="post" action="">
                                    <fieldset>
                                        ...
                                        <input class="btn btn-lg btn-success btn-block" type="submit" name="edit_user" value="Edit User">
                                      <br>
                                          <?php 
                                            if(isset($error)){
                                                echo $error;
