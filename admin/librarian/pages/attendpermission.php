...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">ATTEND TO PERMISSIONS </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $rows['campus']?> </td>
                                        <td><?= $rows['d_o_p']?> </td>
                                        <td><?= $rows['resume_date']?> </td>
                                        <td>
                                            <a href="<?= '?id=' . $rows['staff_id']. '&status=accepted'?> "><button class="msg btn btn-success" id="msg" value="<?=$row['staff_id']?>"> Accept </button></a>
                                            <a href="<?= '?id=' . $rows['staff_id'] . '&status=rejected'?> "><button class="msg btn btn-danger" id="msg" value="<?=$row['staff_id']?>"> Reject </button></a>
                                        </td><br>
    ...
    $(document).ready(function() {
      ...
      // console.log($('#msg'));
        ...
        $.ajax({
            method: "POST",
            url:'/library/admin/librarian/update_db.php',
            data:$('').val(),
