        ...
        <div id="page-wrapper">
            <div class="panel">
                <div class="panel-heading">
                    <h1> Send Memo Here </h1>
                </div>
                <div class="panel-body">
                     <form role="form" action="" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <label> Select One Staff  : </label>
                                     <select style="width:85%;margin-left:20px; float: right;" name="select_one[]" class="form-control"  placeholder="Select One Staff" >
                                        <option value="Staff 1"> Staff One </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label> Select Destination  : </label>
                                     <select style="width:85%;margin-left:20px; float: right;" name="select_one[]" class="form-control"  placeholder="Select Destination" >
                                        <option value="Librarian"> Librarian </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label> Select Source : </label>
                                     <select style="width:85%;margin-left:20px; float: right;" name="select_one[]" class="form-control"  placeholder="Select Source" >
