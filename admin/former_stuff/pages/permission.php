<?php
    ...
    if(isset($_POST['send_permission'])){
        ...
        $error ="";
        //check if empty
        if(!empty($fname) && !empty($lname) && !empty($staff_id) && !empty($resume_date) && !empty($status)){
            ...
            $resume_date_checks = $checkobject->inputs($resume_date);
            
            $status_checks = $checkobject->inputs($status);
            
            if($fname_checks && $lname_checks && $staff_id_checks && $resume_date_checks){
                
                //calling the permission class
                
                $permission =  new permission();
                
                if($permission ->user_exists($staff_id)){
                    
                    if($permission->send($fname,$lname,$staff_id,$resume_date,$status)){
                ...
                <div class="panel-body">
                     <form role="form" action="" method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Resume Date" name="resume_date" type="text" autofocus title="Format is : 2018-05-10 ">
                                    <br>
                                    <span class="alert alert-info pull-right"> Format is : 2018-05-10 </span>
                                    
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="Status Here" name="status"></textarea>
                                </div>
<!--
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="Admin Comment Here" name="admin_comment"></textarea>
                                </div>
-->
