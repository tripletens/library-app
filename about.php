...
<head>
	<title> About Us :: Chukwuemeka Odumegwu Ojukwu University </title>
	<!-- meta-tags -->
	...
	<div class="header-top">
		<div class="container">
			<div class="bottom_header_left">
				<p>
					<span class="fa fa-map-marker" aria-hidden="true"></span> About Us
				</p>
			</div>
		...
		<div class="container">
			...
			<div class="about-sub">
				<div class="col-md-6 about_bottom_left">
					...
					<p>The COOU Libraries are situated at various faculties of the University different campuses, for easy access of Library resources.</p>
					<p>The University Main Library at the Igbariam Campus has an entirely dedicated building divided into two major compartments - The Traditional Library and the e-Library. This compartmentalization is also implemented in the other libraries, although they have no dedicated buildings but have dedicated spaces or rooms in general-purpose buildings. The e-Library of the University Main Library has attracted government bodies like JAMB, Immigration, Police, etc. to hire its facility for e-Trainings, e-Exams and Conferences. Each Unit of the Library has a Unit head who all reports to the University Librarian. </p>
					...
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color1">
								<a href="#" data-toggle="modal" data-target="#myModal">University Main Library</a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#">
										<span class="fa fa-clock-o" aria-hidden="true"></span> 10:00am - 4:00pm (Week-days)</a>
								</div>
								<div class="time">
									<p>
										<span class="fa fa-map-marker" aria-hidden="true"></span> Igbariam Campus </p>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color2">
								<a href="#" data-toggle="modal" data-target="#myModal">Engineering / Environmental Libraries</a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#">
								...
								<div class="time">
									<p>
										<span class="fa fa-map-marker" aria-hidden="true"></span> Uli Campus </p>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="news-grid-info-bottom-w3ls-text">
					...
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color3">
								<a href="#" data-toggle="modal" data-target="#myModal">Medical Library </a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#">
								...
								<div class="time">
									<p>
										<span class="fa fa-map-marker" aria-hidden="true"></span> Amaku Awka Campus </p>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="news-grid-info-bottom-w3ls-text">
					...
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color4">
								<a href="#" data-toggle="modal" data-target="#myModal">Law Library</a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#">
								...
								<div class="time">
									<p>
										<span class="fa fa-map-marker" aria-hidden="true"></span> Law Facaulty, Igbariam Campus </p>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="news-grid-info-bottom-w3ls-text">
			...
			<div class="container">
				<div class="mkls_footer_grid">
					<div class="col-xs-4 mkls_footer_grid_left">
						<h4>Location:</h4>
						<p>Chukwuemeka Odumegwu Ojukwu University
							<br> Igbariam / Uli / Awka, Anambra State, Nigeria</p>
					</div>
					<div class="col-xs-4 mkls_footer_grid_left">
						<h4>Mail Us:</h4>
						<p>
							<span>Phone : </span>+234803 882 7669</p>
						<p>
							<span>Email : </span>
		...
		<div class="footer-copy-right">
			<div class="container">
				<div class="allah-copy">
					<p>© 2018 COOU Library. All rights reserved | 
